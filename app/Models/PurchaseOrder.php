...
#[Fillable([
    'po_number', 'vendor_id', 'warehouse_id', 'source_order_id', 'status', 'order_date',
...
class PurchaseOrder extends Model
{
    ...
    /**
     * Set only on a PO auto-generated by AutoPurchaseOrderService — the
     * sales order whose consumption it exists to cover. Manually-created
     * POs have no source order and this stays null.
     */
